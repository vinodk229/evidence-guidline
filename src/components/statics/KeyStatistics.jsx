      ...
      <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-3">
            {skills.map((skill, index) => (
              <Link to={skill.path}
                key={index}
                className="w-auto h-[100px] xl:h-[150px] group rounded-full border bg-white border-gray-200 flex items-center px-7 transition-all duration-300 hover:shadow-lg"
              >
                {/* Icon Circle */}
                ...
                <div className="ml-6">
                  ...
                  <h2 className="text-2xl xl:text-5xl font-medium leading-none text-black">
                    {skill.percentage}
                  </h2>
                </div>
              </Link>
